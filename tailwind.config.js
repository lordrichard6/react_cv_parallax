  ...
  theme: {
    extend: {
      backgroundImage: theme => ({
        ...
        'projects': "linear-gradient(to right, rgba(0, 0, 0, 0.9),rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.9)), url('/src/img/bg_projects-min.jpg')",
        'projects-mobile': "url('/src/img/bg_projects_mobile-min.jpg')",
        'education': "linear-gradient(to right, rgba(0, 0, 0, 0.9),rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.9)), url('/src/img/bg_education-min.jpg')",
        'education-mobile': "url('/src/img/bg_education_mobile-min.jpg')",
        'experience': "linear-gradient(to right, rgba(0, 0, 0, 0.9),rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.9)), url('/src/img/bg_experience-min.jpg')",
        'experience-mobile': "url('/src/img/bg_experience_mobile-min.jpg')",
        'skills': "linear-gradient(to right, rgba(0, 0, 0, 0.9),rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.9)), url('/src/img/bg_skills-min.jpg')",
