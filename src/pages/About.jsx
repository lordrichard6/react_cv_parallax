...
const About = () => {
  return (
    <section className="h-screen p-6 mt-40">
      <div className="flex justify-center">
        <img src={title} alt="title" className="h-20 md:w-1/3 md:h-auto z-40" />
      </div>
      <div className="p-2 relative">
        ...
        <div className="flex flex:col flex-wrap md:flex-row justify-center">
          <p className="md:flex-1 pt-10 leading-relaxed text-xl md:text-2xl 2xl:text-4xl">
          ...
          <img src={me1} alt="title" className="h-80 md:w-1/3 md:h-auto md:flex-1 2xl:flex-none rounded-full shadow-2xl" />
